...
object AdministrativeFormUtils {
...
object UserCredentialsGenerator {
    ...
    fun generateUsername(
        ...
        // Para corporativo usamos "CORP" en lugar de código de sucursal
        return "CORP$firstLetterPaternal$firstLetterMaternal$firstTwoLettersName$companyAcronym$randomSuffix"
    }
    ...
    fun generatePassword(
        ...
        val dateCode = AdministrativeFormUtils.getCurrentDate().replace("-", "")
        val randomSuffix = kotlin.random.Random.nextInt(10, 100)
